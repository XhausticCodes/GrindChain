  ...
  if (loading) {
    return (
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-purple-500/20 rounded-xl p-5 shadow-xl w-full h-full">
        <h3 className="text-lg font-bold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent mb-4">
          📅 Upcoming Tasks
        </h3>
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-purple-500/20 rounded-xl p-5 shadow-xl w-full h-full">
      ...
      <div className="relative z-10">
        ...
        <ul className="space-y-2 overflow-y-auto max-h-73 hide-scrollbar-upcoming px-0.5">
            ...
            >
              <span
                className={`bg-gradient-to-r ${getPriorityColor(
                  task.priority
                )} text-white rounded-full w-7 h-7 flex items-center justify-center text-xs font-bold shadow-lg`}
              >
