...
const Analytics = () => {
      ...
      <div className="relative h-full w-full overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500 text-sm">Create some tasks to see analytics</p>
          </div>
        </div>
      </div>
    );
  ...
  const priorityData = [
    { name: 'High Priority', value: analytics.priorityBreakdown.high, color: priorityColors.high },
    { name: 'Medium Priority', value: analytics.priorityBreakdown.medium, color: priorityColors.medium },
    { name: 'Low Priority', value: analytics.priorityBreakdown.low, color: priorityColors.low }
    ...
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full overflow-y-auto p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-400">Track your productivity and task completion metrics</p>
        </div>
          ...
          <div className="bg-gradient-to-r from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-600/30 rounded-xl p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-400">{analytics.totalTasks - analytics.completedTasks}</p>
              </div>
            ...
            {analytics.tasks.map((task) => (
              <div key={task.id} className="flex items-center justify-between p-3 bg-slate-700/30 rounded-lg">
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-gray-300 truncate font-medium">{task.title}</p>
